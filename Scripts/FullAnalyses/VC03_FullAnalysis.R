...
rem_freq <- rma(yi = yi, sei = sei, data = GroupTenure[GroupTenure$risk_of_bias != "high",])
...
pubbias.some <- RobustBayesianCopas(y = GroupTenure[GroupTenure$risk_of_bias != "high",]$yi, 
                                    s = GroupTenure[GroupTenure$risk_of_bias != "high",]$sei, 
                                    init=NULL, re.dist=c("normal"),
                                    burn=10000, nmc=10000)

pubbias.someST <- RobustBayesianCopas(y = GroupTenure[GroupTenure$risk_of_bias != "high",]$yi, 
                                      s = GroupTenure[GroupTenure$risk_of_bias != "high",]$sei, 
                                      init=NULL, re.dist=c("StudentsT"),
                                      burn=10000, nmc=10000)

pubbias.someL <- RobustBayesianCopas(y = GroupTenure[GroupTenure$risk_of_bias != "high",]$yi, 
                                     s = GroupTenure[GroupTenure$risk_of_bias != "high",]$sei, 
                                     init=NULL, re.dist=c("Laplace"),
                                     burn=10000, nmc=10000)

pubbias.someSL <- RobustBayesianCopas(y = GroupTenure[GroupTenure$risk_of_bias != "high",]$yi, 
                                      s = GroupTenure[GroupTenure$risk_of_bias != "high",]$sei, 
...
pubbias.none <- BayesNonBiasCorrected(y = GroupTenure[GroupTenure$risk_of_bias != "high",]$yi, 
                                      s = GroupTenure[GroupTenure$risk_of_bias != "high",]$sei,
