...
rem_freq <- rma(yi = yi, sei = sei, data = GroupSanctions[GroupSanctions$risk_of_bias != "high",])
...
pubbias.some <- RobustBayesianCopas(y = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$yi, 
                                    s = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$sei, 
                                    init=NULL, re.dist=c("normal"),
                                    burn=10000, nmc=10000)

pubbias.someST <- RobustBayesianCopas(y = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$yi, 
                                      s = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$sei, 
                                      init=NULL, re.dist=c("StudentsT"),
                                      burn=10000, nmc=10000)

pubbias.someL <- RobustBayesianCopas(y = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$yi, 
                                     s = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$sei, 
                                     init=NULL, re.dist=c("Laplace"),
                                     burn=10000, nmc=10000)

pubbias.someSL <- RobustBayesianCopas(y = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$yi, 
                                      s = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$sei, 
...
pubbias.none <- BayesNonBiasCorrected(y = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$yi, 
                                      s = GroupSanctions[GroupSanctions$risk_of_bias != "high",]$sei,
