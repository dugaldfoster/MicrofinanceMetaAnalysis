...
rem_freq <- rma(yi = yi, sei = sei, data = BorrowerSex[BorrowerSex$risk_of_bias != "high",])
...
pubbias.some <- RobustBayesianCopas(y = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$yi, 
                                    s = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$sei, 
                                    init=NULL, re.dist=c("normal"),
                                    burn=10000, nmc=10000)

pubbias.someST <- RobustBayesianCopas(y = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$yi, 
                                      s = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$sei, 
                                      init=NULL, re.dist=c("StudentsT"),
                                      burn=10000, nmc=10000)

pubbias.someL <- RobustBayesianCopas(y = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$yi, 
                                     s = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$sei, 
                                     init=NULL, re.dist=c("Laplace"),
                                     burn=10000, nmc=10000)

pubbias.someSL <- RobustBayesianCopas(y = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$yi, 
                                      s = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$sei, 
...
pubbias.none <- BayesNonBiasCorrected(y = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$yi, 
                                      s = BorrowerSex[BorrowerSex$risk_of_bias != "high",]$sei,
