...
rem_freq <- rma(yi = yi, sei = sei, data = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",])
...
pubbias.some <- RobustBayesianCopas(y = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$yi, 
                                    s = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$sei, 
                                    init=NULL, re.dist=c("normal"),
                                    burn=10000, nmc=10000)

pubbias.someST <- RobustBayesianCopas(y = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$yi, 
                                      s = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$sei, 
                                      init=NULL, re.dist=c("StudentsT"),
                                      burn=10000, nmc=10000)

pubbias.someL <- RobustBayesianCopas(y = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$yi, 
                                     s = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$sei, 
                                     init=NULL, re.dist=c("Laplace"),
                                     burn=10000, nmc=10000)

pubbias.someSL <- RobustBayesianCopas(y = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$yi, 
                                      s = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$sei, 
...
pubbias.none <- BayesNonBiasCorrected(y = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$yi, 
                                      s = ExtMonitoring[ExtMonitoring$risk_of_bias != "high",]$sei,
